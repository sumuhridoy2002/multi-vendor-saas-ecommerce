                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7">
                        <div class="card-body p-5">
                            <h4 class="mb-1 font-weight-bold text-primary text-center">Welcome Back!</h4>
                            <p class="text-center mb-4 small text-gray-600">Login to your account</p>
                            @if (session('status'))
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group form-check mt-3">
                                    ...
                                    <label class="form-check-label small text-gray-700" for="remember_me">Remember me</label>
                                </div>
                            ...
                            <div class="mt-3 text-center">
                                <span class="small text-muted">Don't have an account?
                                    @if(Route::has('register'))
                                        <a href="{{ route('register') }}" class="text-primary font-weight-bold ml-1">Register</a>
                                    @endif
                                </span>
                            </div>
                        </div>
