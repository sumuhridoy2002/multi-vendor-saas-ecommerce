...
@section('content')
        ...
        <div id="ecomSlider" class="carousel slide shadow" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://images.unsplash.com/photo-1513708925359-d2853ae72c53?auto=format&fit=crop&w=900&q=80" class="d-block w-100 carousel-img" alt="Shop the Best Products" onerror="this.onerror=null;this.src='https://placehold.co/900x400?text=Not+Found';">
                ...
                <div class="carousel-item">
                    <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=900&q=80" class="d-block w-100 carousel-img" alt="Big Sale Weekend" onerror="this.onerror=null;this.src='https://placehold.co/900x400?text=Not+Found';">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="https://images.unsplash.com/photo-1416339306562-f3d12fefd36f?auto=format&fit=crop&w=900&q=80" class="d-block w-100 carousel-img" alt="Electronics & More" onerror="this.onerror=null;this.src='https://placehold.co/900x400?text=Not+Found';">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container mb-3">
        <div class="row text-center align-items-end">
            ...
            <div class="col-md-3 mb-4">
                <div class="card py-4 border-0 shadow-sm">
                    <img src="https://images.unsplash.com/photo-1503389152951-9c3d029bd29c?auto=format&fit=crop&w=400&q=80" alt="Home & Living" class="mx-auto mb-3" style="height:60px; width:auto;object-fit:cover;border-radius:50%;" onerror="this.onerror=null;this.src='https://placehold.co/60x60?text=Not+Found';">
                    <h5>Home & Living</h5>
            ...
            <div class="col-md-3 mb-4">
                <div class="card py-4 border-0 shadow-sm">
                    <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=400&q=80" alt="Health & Beauty" class="mx-auto mb-3" style="height:60px; width:auto;object-fit:cover;border-radius:50%;" onerror="this.onerror=null;this.src='https://placehold.co/60x60?text=Not+Found';">
                    <h5>Health & Beauty</h5>
    ...
    <div class="container mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100 border-0 shadow-sm">
                    <img src="https://images.unsplash.com/photo-1511351819117-43612e87b160?auto=format&fit=crop&w=400&q=80" alt="Headphones" class="card-img card-img-top w-100" onerror="this.onerror=null;this.src='https://placehold.co/400x200?text=No+Image';">
                    <div class="card-body text-center">
